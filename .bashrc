...
# enable to automatically log out after a period of inactivity, however
# this was undesirable with TMUX. TODO: timeout in a TTY only
# TMOUT=3600

# Larger history, both in memory for the session and in file
HISTSIZE=3000
HISTFILESIZE=5000
